package cl.corona.integrationgroupd.service;
...
public class intUpload {
    ...
    @Value("${sftpd.dst_MTCSDIINVTRE}")
    private String d_sftpdtn_MTCSDIINVTRE;
                ...
                switch (sSubCadena) {
                    case "MTCSDIINVTRE":
                        if (file.isFile()) {
                            ...
                            LOG.info("Uploading MTCSDIINVTRE " + filename + " ---> " + d_sftpdtn_MTCSDIINVTRE);
                            d_sftp.put(filename, d_sftpdtn_MTCSDIINVTRE);
                            file.delete();
